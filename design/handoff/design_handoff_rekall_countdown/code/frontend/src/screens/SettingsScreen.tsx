  ...
  return (
    <div className="flex flex-col gap-6 lg:grid lg:grid-cols-2 lg:items-start lg:gap-x-10">
      ...
      <Section title="Appearance">
        ...
        <Row label="Accent" hint="Used for the countdown, the calendar load, the main button and the active tab.">
...
function Row({ label, hint, children }: { label: string; hint: string; children: React.ReactNode }) {
  return (
    <div className="flex flex-col gap-2 py-3.5">
      ...
      <div className="text-[0.8125rem] leading-relaxed text-[var(--text-muted)]">{hint}</div>
    </div>
  )
}
