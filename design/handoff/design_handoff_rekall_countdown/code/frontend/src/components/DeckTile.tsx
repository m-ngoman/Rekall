...
export default function DeckTile({ deck, onClick, onEdit, onDelete }: Props) {
  ...
  return (
    <div
      className={`flex cursor-pointer items-center gap-3.5 rounded-[var(--r-md)] bg-[var(--surface)] px-4 py-3.5 ${
    ...
    >
      ...
      {onEdit && (
        <button
          ...
          className="flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-[var(--r-sm)] text-[var(--text-muted)]"
        >
